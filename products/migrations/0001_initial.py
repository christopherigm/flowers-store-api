    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.PositiveSmallIntegerField(default=1)),
                ('name', models.CharField(max_length=64, unique=True)),
                ('feature', models.ForeignKey(help_text='Caracteristica del producto', on_delete=django.db.models.deletion.CASCADE, to='products.productfeature', verbose_name='Caracteristica del producto')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='options',
            field=models.ManyToManyField(blank=True, related_name='product_feature_options', to='products.ProductFeatureOption', verbose_name='Opciones de caractarísticas del producto'),
        ),
        migrations.AddField(
            model_name='product',
            name='classification',
            field=models.ForeignKey(help_text='Clasificación al que pertenece este registro', null=True, on_delete=django.db.models.deletion.CASCADE, to='products.productclassification', verbose_name='Clasificación'),
        ),
        migrations.AddField(
            model_name='product',
            name='delivery_type',
            field=models.ManyToManyField(blank=True, help_text='Tipo de entrega', related_name='delivery_type', to='products.ProductDeliveryType', verbose_name='Tipo de entrega'),
        ),
        migrations.AddField(
            model_name='product',
            name='features',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, help_text='Fotos del producto', related_name='product_pictures', to='products.ProductPicture', verbose_name='Fotos'),
        ),
        migrations.AddField(
            model_name='product',
            name='related',
            field=models.ManyToManyField(blank=True, related_name='related_products', to='products.Product', verbose_name='Productos relacionados'),
        ),
    ]
