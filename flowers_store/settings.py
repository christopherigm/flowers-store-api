"""
Django settings for flowers_store project.
...
BROKER_COMMISSION = 2.9

BROKER_STATIC_COMMISSION = 2.5

NATIONAL_TAX = 16

OP_API_KEY = env.OP_API_KEY

OP_MERCHANT_ID = env.OP_MERCHANT_ID

OP_VERIFY_SSL_CERTS = env.OP_VERIFY_SSL_CERTS

OP_PRODUCTION = env.OP_PRODUCTION
